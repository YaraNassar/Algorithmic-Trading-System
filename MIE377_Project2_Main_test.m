...
%% 1. Read input files 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
assetDatalist = ["MIE377_AssetPrices_1.csv", "MIE377_AssetPrices_2.csv", "MIE377_AssetPrices_3.csv"];
factorDatalist = ["MIE377_FactorReturns_1.csv", "MIE377_FactorReturns_2.csv", "MIE377_FactorReturns_3.csv" ];

for i = 1:length(assetDatalist)
    clear portfRets portfExRets portfValue
    % Input file names
    assetData  = assetDatalist(i);
    factorData = factorDatalist(i);
    ...
    SR(i) = (geomean(portfExRets + 1) - 1) / std(portfExRets);
    
    % Calculate the average turnover rate
    avgTurnover(i) = mean(turnover(2:end));
    ...
    print(fig1,'fileName'+ string(i),'-dpng','-r0');
    ...
    %If you want to save the figure as .pdf for use in LaTeX
    %print(fig2,'fileName2' + string(i),'-dpdf','-r0');
    
    % If you want to save the figure as .png for use in MS Word
    print(fig2,'fileName2' + string(i),'-dpng','-r0');
end
results = [SR' avgTurnover'];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Program End